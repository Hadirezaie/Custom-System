...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tarif.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TARIF_LIST actions', async () => {
    ...
    it('dispatches FETCH_TARIF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TARIF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TARIF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TARIF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TARIF actions', async () => {
      const expectedActions = [
        {
