...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMCHARGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_CUSTOMCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CUSTOMCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CUSTOMCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CUSTOMCHARGES actions', async () => {
      const expectedActions = [
        {
