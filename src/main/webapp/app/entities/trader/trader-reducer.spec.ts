...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './trader.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRADER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRADER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRADER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRADER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRADER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRADER actions', async () => {
      const expectedActions = [
        {
